...
const RealProjects = () => {
    ...
    const Skeleton = (url?: any, isSquare?: boolean) => (
        <div className="flex flex-1 w-full h-fit overflow-hidden rounded-md">
            <Image alt="" className={`w-full object-cover ${isSquare? "aspect-square" : ""} h-fit`} width={200} height={100} src={url.url}></Image>
        </div>
    );
    ...
    const items = [
        ...
        },
        {
            ...
            header: <Skeleton isSquare={true} url="/assets/gif/app-gsmfeed-mobile.gif" />,
            icon: <IconFileBroken className="h-4 w-4 text-neutral-500" />,
        },
    ];
