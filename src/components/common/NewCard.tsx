...
const NewCard = ({ prop }: any) => {
    ...
    return (
        <div className="border bg-gradient-to-b !w-[88%] md:!w-full from-pink-400 via-purple-500 to-blue-500 rounded-2xl !shadow-none px-[0.7px] py-[0.7px] ">
            <div className="bg-[#0f0f0f] flex flex-col w-full h-full rounded-[15px] px-8 py-3">
                ...
                <div className="flex-1 pt-3 md:pb-6 block font-sans text-[16px] font-thin leading-relaxed antialiased">
                    {prop ? description : (
                        <div className='animate-pulse flex w-full flex-col gap-2'>
